                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="header-title">
                            <h4 class="card-title"><span class="badge bg-warning p-3">LF-W01-MIC-03 : ANALYST WORKSHEET FOR BACTERIOLOGICAL EXAMINATION OF FISH AND FISHERY PRODUCTS</span></h4>
                                ...
                                <table id="documentsTable" class="table table-striped" role="grid" data-bs-toggle="data-table">
                                    <thead>
                                        <tr class="light">
                                            ...
                                            <th class="text-wrap">Lab Unit</th>
                                    ...
                                    <tbody>
                                        @foreach ($rla as $r)
                                             <tr>
                                                ...
                                                <td class="text-wrap">{{ $r->lab_unit}}</td>
                                                ...
                                                @php
                                                    $statuses = [
                                                        ...
                                                        3 => ['label' => 'Analysis Worksheet', 'class' => 'bg-danger'],
                                                        4 => ['label' => 'Equipment Logs', 'class' => 'bg-secondary'],
                                                        5 => ['label' => 'Equipment Logs', 'class' => 'bg-secondary'],
                                                ...
                                                <td class="text-wrap">
                                                    ...
                                                    <div class="flex align-items-center list-user-action">
                                                        ...
                                                        @php
                                                            $isDisabled = $r->status != 3;
                                                        @endphp
                                                        {{-- <a class="btn btn-sm btn-icon btn-success editRlaBtn {{ $isDisabled ? 'disabled' : '' }}"
                                                            href="{{ route('analysis_worksheet.create', $r->id) }}"
                                                            data-bs-toggle="tooltip" data-bs-placement="top" data-original-title="Edit"  aria-label="Edit" data-bs-original-title="Edit"
                                                            style="{{ $isDisabled ? 'pointer-events:none; opacity:0.6;' : '' }}">
                                                                <span class="btn-inner">
                                                            ...
                                                            <a class="btn btn-sm btn-icon btn-warning editRlaBtn {{ $isDisabled ? 'disabled' : '' }}"
                                                                ...
                                                                aria-label="Analysis Worksheet"
                                                                style="{{ $isDisabled ? 'pointer-events:none; opacity:0.6;' : '' }}">
                                                                <span class="btn-inner">
                                                                    <svg class="20" width="20" viewBox="0 0 24 24" fill="none"
                                                        ...
                                                        <a class="btn btn-sm btn-icon btn-info"
                                                            href="{{ route('analysis.download.pdf', $r->id) }}" data-download
                                                            data-bs-toggle="tooltip"
                                                            title="Download PDF">
                                                                <span class="btn-inner">
                                                                    <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            ...
                                                            @php
                                                                $isDisabled = $r->status != 3;
                                                            @endphp
                                                               <form action="{{ route('update.statusAW', $r->id) }}" method="POST" class="d-inline check-form">
                                                                    @csrf
                                                                      <button type="submit"
                        ...
                        <div class="form-sheet">
                            ...
                            <table class="bordered mb-3" style="color:black">
                             ...
                             <form method="POST" action="{{ route('lf_06_02.store')}}">
                                ...
                                <table class="table table-bordered text-center" style="font-size:12px; color:black;">

                                    <!-- HEADER -->
                                    <tr>
                                        <th>RLA No.:</th>
                                        <th>Lab Code:</th>
                                        <th colspan="3">Date/Time Started:</th>
                                        <th colspan="3">Date/Time Finished:</th>
                                    </tr>
                                    <tr>
                                        <td>{{ $rla_no ?? '' }}</td>
                                        <td>{{ $lab_code ?? '' }}</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>R1 / R2</td>
                                        <td>
                                            <input type="text" name="aerobic_plate_count_result" class="form-control border-0 border-bottom text-center">
                                            cfu/g
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td colspan="6"><strong>No. of + Replicates</strong></td>
                                        <td></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">10⁻² (0.01)</td>
                                        <td colspan="2">10⁻³ (0.001)</td>
                                        <td></td>
                                    </tr>

                                    <!-- TOTAL COLIFORM -->
                                    <tr>
                                        <td>Total Coliform Count</td>
                                        <td colspan="2">LST Broth:<br>BGLB Broth:</td>
                                        <td colspan="2">LST Broth:<br>BGLB Broth:</td>
                                        <td colspan="2">LST Broth:<br>BGLB Broth:</td>
                                        <td>
                                            <input type="text" name="total_col_count_result" class="form-control border-0 border-bottom text-center">
                                            MPN/g
                                        </td>
                                    </tr>
                                    ...
                                    <!-- FECAL -->
                                    <tr>
                                        <td>Fecal Coliform Count</td>
                                        <td colspan="2">EC Broth:</td>
                                        <td colspan="2">EC Broth:</td>
                                        <td colspan="2">EC Broth:</td>
                                        <td>
                                            <input type="text" name="fecal_col_count_result" class="form-control border-0 border-bottom text-center">
                                            MPN/g
                                        </td>
                                    </tr>
                                    ...
                                    <!-- E.COLI -->
                                    <tr>
                                        <td><i>Escherichia coli</i> Count</td>
                                        <td colspan="2">L-EMB Agar:<br>Confirmed Tests:</td>
                                        <td colspan="2">L-EMB Agar:<br>Confirmed Tests:</td>
                                        <td colspan="2">L-EMB Agar:<br>Confirmed Tests:</td>
                                        <td>
                                            <input type="text" name="esc_coli_count_result" class="form-control border-0 border-bottom text-center">
                                            MPN/g
                                        </td>
                                    </tr>
                                    ...
                                    <!-- STAPH -->
                                    <tr>
                                        <td><i>Staphylococcus aureus</i> Count</td>
                                        <td colspan="2">R1 0.3 ml / R2 0.3 ml / R3 0.4 ml<br>Coagulase Test / Catalase Test</td>
                                        <td colspan="2">R1 0.3 ml / R2 0.3 ml / R3 0.4 ml<br>Coagulase Test / Catalase Test</td>
                                        <td colspan="2">R1 0.3 ml / R2 0.3 ml / R3 0.4 ml<br>Coagulase Test / Catalase Test</td>
                                        <td>
                                            <input type="text" name="staphy_aureus_count_result" class="form-control border-0 border-bottom text-center">
                                            cfu/g
                                        </td>
                                    </tr>
                                    ...
                                    <!-- SALMONELLA -->
                                    <tr>
                                        <td rowspan="4"><i>Salmonella sp.</i></td>
                                        <td colspan="6">pH: &nbsp;&nbsp;&nbsp;&nbsp; Incubation at Room Temperature: Time Started: _____ Time Ended: _____</td>
                                        <td rowspan="4">
                                            <input type="text" name="salmonella_result" class="form-control border-0 border-bottom text-center">
                                            per 25 g sample
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="6">
                                            Isolation: <br>
                                            RV Medium | TT Broth <br>
                                            BS Agar | XLD Agar | HE Agar
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="6">
                                            TSI Agar Slant / TSI Agar Butt <br>
                                            LIA Butt
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <!-- SHIGELLA -->
                                    <tr>
                                        <td rowspan="2"><i>Shigella sp.</i></td>
                                        <td colspan="6">
                                            Isolation: McConkey Agar Plate
                                        </td>
                                        <td rowspan="2">
                                            <input type="text" name="shigella_result" class="form-control border-0 border-bottom text-center">
                                            per 25 g sample
                                        </td>
                                    </tr>
                                    <tr>
