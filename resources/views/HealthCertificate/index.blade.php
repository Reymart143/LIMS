                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="header-title">
                            <h4 class="card-title"><span class="badge bg-warning p-3 mb-3">  HEALTH CERTIFICATE FOR TRANSBOUNDARY MOVEMENT OF LIVE FISH AND FISHERY/AQUATIC PRODUCTS </span></h4>
                            <span class="text-danger mt-3"> Download Button will be disabled if no health certificates added.</span>
                        </div>
                                             ...
                                             <tr>
                                                ...
                                                <td class="text-wrap">
                                                    ...
                                                    <div class="flex align-items-center list-user-action">
                                                      <a class="btn btn-sm btn-icon btn-warning editRlaBtn"
                                                            href="{{ route('healthcertificate.create', $r->id) }}"
                                                            title="Add"
                                                            aria-label="Add">
                                                        ...
                                                        @if(!empty($r->health_certificate_id))

                                                            <a class="btn btn-sm btn-icon btn-info"
                                                            href="{{ route('HC.download.pdf', $r->id) }}"
                                                            data-download
                                                        ...
                                                        @else
                                                            ...
                                                            <button type="button"
                                                                    ...
                                                                    disabled
                                                                    data-bs-toggle="tooltip"
                                                                    title="Please add Health Certificate first">
