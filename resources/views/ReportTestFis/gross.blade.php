...
@php
    ...
    */
    ...
    |--------------------------------------------------------------------------
    | RESULT VALUES
    | Option 1: worksheet->results JSON per lab code
    | {
    |   "RFL12-26-001": "Good and healthy",
    |   "RFL12-26-002": "With parasites observed"
    | }
    |
    | Option 2: worksheet->result single value
    |--------------------------------------------------------------------------
    */
    $worksheetResults = [];
    ...
    $getResultValue = function ($labCode) use ($worksheetResults, $worksheet) {
    ...
    |--------------------------------------------------------------------------
    */
    $testName = !empty($analysisDescription)
        ? ucwords(strtolower($analysisDescription))
        : 'Gross Examination';

    $method = !empty($worksheet->test_method)
        ? $worksheet->test_method
...
<table class="result-table">
    <thead>
        <tr>
            <th style="width:130px;">LABORATORY<br>CODE(S)</th>
            <th style="width:150px;">SAMPLE CODE(S)</th>
